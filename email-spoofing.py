...
# Author  : GabrielGonta
# GitHub  : https://github.com/gabrielgonta/
# Version : 1.0
...
def check_limit(sent, amount, target, type):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] Sent \033[37m"+str(amount)+"\033[92m Emails To \033[37m"+target+"\033[92m By Email-Spoofing...")
        return True
    else:
        if (type == "custom"):
            time.sleep(3)
...
def spoof():
    ...
    if ("success" in response):
        psb("\n\033[92m    [\033[37m*\033[92m] Successfully Spoofed Mail To \033[37m"+target+"\033[92m From \033[37m"+mail+"\033[92m By Email-Spoofing...")
        sys.exit("\033[37m")
    else:
        psb("\n\033[92m    [\033[91m!\033[92m] There Was a Probleam Spoofing Your Mail!")
        psb("\n\033[92m    [\033[91m!\033[92m] Please Try Again After Some Time or Contact with GabrielGonta!")
        sys.exit("\033[37m")
...
if __name__ == "__main__":
    ...
    print("\033[3;90m                     A Product Of GabrielGonta\033[0;92m")
    ...
    try:
        ...
        psb("\033[92m    [\033[91m!\033[92m] Please Contact GabrielGonta or Try Again After Some Time.... \033[37m\n")
        time.sleep(0.8)
        sys.exit()
    main()
